        ...
        allLanes.forEach(lane => {
            for (let headIdx = 0; headIdx < NUM_HEAD_SETS_LAYER; headIdx++) {
                ...
                ctx.animateVectorMatrixPassThrough(
                    ...
                    ctx.brightGreen,
                    ctx.darkTintedGreen,
                    ctx.finalHeadColors ? ctx.finalHeadColors.K : ctx.brightGreen,
                ...
                if (qSideCopy && qSideCopy.vec) {
                    ctx.animateVectorMatrixPassThrough(
                        ...
                        ctx.brightBlue,
                        ctx.darkTintedBlue,
                        ctx.finalHeadColors ? ctx.finalHeadColors.Q : ctx.brightBlue,
                        ctx.mhaPassThroughTargetY,
                        ctx.mhaPassThroughDuration,
                        ctx.mhaResultRiseOffsetY,
                        ctx.mhaResultRiseDuration,
                ...
                if (vSideCopy && vSideCopy.vec) {
                    ctx.animateVectorMatrixPassThrough(
                        ...
                        ctx.brightRed,
                        ctx.darkTintedRed,
                        ctx.finalHeadColors ? ctx.finalHeadColors.V : ctx.brightRed,
                        ctx.mhaPassThroughTargetY,
                        ctx.mhaPassThroughDuration,
                        ctx.mhaResultRiseOffsetY,
                        ctx.mhaResultRiseDuration,
