        ...
        lanes.forEach(lane => {
            if (lane.ln2Phase === 'done' && !lane.mlpUpStarted) {
                ...
                if (vec) {
                    ...
                    const matrixEndColor = new THREE.Color(0xaf5faf); // bright purple-pink
                    new TWEEN.Tween({ t: 0 })
                        .to({ t: 1 }, duration)
                                ...
                                .onComplete(() => {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        new TWEEN.Tween({ t: 0 })
                                            ...
                                            .easing(TWEEN.Easing.Quadratic.InOut)
                                            .onUpdate(o => {
                                                const col = mlpDarkGray.clone().lerp(mlpHighlightColor, o.t);
                                        ...
                                        new TWEEN.Tween(expandedGroup.position)
                                            ...
                                            .onComplete(() => {
                                                mlpMatrixDown.setColor(mlpHighlightColor);
                                                mlpMatrixDown.setEmissive(mlpHighlightColor, 0.5);
