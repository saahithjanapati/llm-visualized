...
// Base width/height for square prisms composing a vector or a prism row
export const PRISM_ROW_ELEMENT_SIZE = 0.25;
export const PRISM_ROW_SPACING = 0.12; // Keep overall row length constant

// Width of prism along the main vector axis (kept small so vectors don't lengthen)
export const PRISM_BASE_WIDTH = 0.1;
