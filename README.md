...
- `precomputed_components_slice.glb`: single-lane slices of common components. Loaded and instanced across lanes.
- `precomputed_components_qkv.glb`: full-depth Q/K/V + output-projection matrices to avoid slit seam artifacts.
